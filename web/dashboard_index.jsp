...
<!DOCTYPE html>
<head>
    <title>Eden | Java Kimathi Street</title>
...
<section id="container">
    ...
    <header class="header fixed-top clearfix">
        <!--logo start-->
        <div class="brand">
            <a href="index.jsp" class="logo">Taka Kenya</a>
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <span class="username">Dennis Mwebia</span>
                        <b class="caret"></b>
                    </a>
        ...
        <div id="sidebar" class="nav-collapse">
            ...
            <div class="leftside-navigation">
                <ul class="sidebar-menu" id="nav-accordion">
                    <li>
                        <a class="active" href="dashboard_index.jsp">
                    ...
                    <li class="sub-menu">
                        <a href="basic_table.jsp">
                            ...
                            <span>Trash Pickup Schedule</span>
                        </a>
                    </li>
                    <li class="sub-menu">
                        <a href="basic_table.jsp">
                            <i class="fa fa-history"></i>
                            <span>Trash Pickup History</span>
                        </a>
                    </li>
                    <li class="sub-menu">
                        <a href="basic_table.jsp">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="flot_chart.jsp">Chart - Reports</a></li>
                            <li><a href="#">General Reports</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="google_map.jsp">
    ...
    <section id="main-content">
                ...
                <div class="col-md-3 market-update-gd">
                    <div class="market-update-block clr-block-2">
                        ...
                        <div class="col-md-8 market-update-left">
                            <h4>Total Waste Hauled</h4>
                            <h3>13.50 t</h3>
                            <p>Total waste hauled as of 2017</p>
                        </div>
                ...
                <div class="col-md-3 market-update-gd">
                    <div class="market-update-block clr-block-1">
                        ...
                        <div class="col-md-8 market-update-left">
                            ...
                            <h3>1,250</h3>
                            <p>Total clients served as of 2017</p>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
                ...
                <div class="col-md-3 market-update-gd">
                    <div class="market-update-block clr-block-4">
                        ...
                        <div class="col-md-8 market-update-left">
                            ...
                            <h3>1,500</h3>
                            <p>Pending waste pick-up requests</p>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
                        ...
                        <div class="agileinfo-grap">
                            <div class="agileits-box">
                                <header class="agileits-box-header clearfix">
                                    <h3>Total Waste Hauled Statistics</h3>
                                    <div class="toolbar">
                ...
                <div class="col-md-4 stats-info widget">
                    <div class="stats-info-agileits">
                        <div class="stats-title">
                            <h4 class="title">Waste Type Stats</h4>
                        </div>
                        <div class="stats-body">
                            <ul class="list-unstyled">
                                <li>Plastics <span class="pull-right">85%</span>
                                    <div class="progress progress-striped active progress-right">
                                        <div class="bar green" style="width:85%;"></div>
                                    </div>
                                </li>
                                <li>Food Remains <span class="pull-right">35%</span>
                                    <div class="progress progress-striped active progress-right">
                                        <div class="bar yellow" style="width:35%;"></div>
                                    </div>
                                </li>
                                <li>Papers <span class="pull-right">78%</span>
                                    <div class="progress progress-striped active progress-right">
                                        <div class="bar red" style="width:78%;"></div>
                                    </div>
                                </li>
                                <li>Glass <span class="pull-right">50%</span>
                                    <div class="progress progress-striped active progress-right">
                                        <div class="bar blue" style="width:50%;"></div>
                                    </div>
                                </li>
                                <li>Organic/Biodegradable <span class="pull-right">80%</span>
                                    <div class="progress progress-striped active progress-right">
                                        <div class="bar light-blue" style="width:80%;"></div>
                                    </div>
                                </li>
                                <li class="last">Metal <span class="pull-right">60%</span>
                                    <div class="progress progress-striped active progress-right">
        ...
        <div class="footer">
            <div class="wthree-copyright">
                <p>Copyright © 2017 Eden Inc. All rights reserved </p>
            </div>
        </div>
        <!-- / footer -->
    </section>
