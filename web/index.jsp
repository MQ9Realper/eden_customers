...
<div class="message warning">
    <div class="inset">
        ...
        <form>
            ...
            <div class="clear"></div>
            <div class="submit">
                <input type="submit" value="Sign in" onclick="window.location.href='/dennis_war_exploded/dashboard_index.jsp';">
                <h4><a href="#">Apply To Join Our Network</a></h4>
                <div class="clear"></div>
            </div>
